    ...
    <header
      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <Link
          ...
          <span className="text-xs font-light text-primary/70 hidden sm:inline">Next-Gen Travel</span>
        </Link>
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <Link to="/holidays" className="text-sm font-medium hover:text-primary transition-colors">Travel Deals</Link>
      ...
      <div className="md:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-lg shadow-lg p-4 border-t border-gray-100 animate-slide-in-bottom">
          <nav className="flex flex-col space-y-4 pt-2 pb-6">
            ...
            <Link to="/holidays" className="text-base font-medium px-4 py-2 hover:bg-gray-50 rounded-md" onClick={() => setIsMobileMenuOpen(false)}>Travel Deals</Link>
            <Link to="/contact" className="text-base font-medium px-4 py-2 hover:bg-gray-50 rounded-md" onClick={() => setIsMobileMenuOpen(false)}>Contact Us</Link>
