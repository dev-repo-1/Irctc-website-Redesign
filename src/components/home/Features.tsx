    ...
    <section className="py-16 lg:py-24 bg-gradient-to-b from-white via-secondary/50 to-background">
      <div className="container max-w-7xl mx-auto px-4 sm:px-6">
        <div
          ...
          <h2 className="text-3xl font-bold text-center mb-3">Our Modern Features</h2>
          <p className="text-muted-foreground text-center mb-12 max-w-xl mx-auto">Discover a modern approach to train travel, featuring innovative designs and digital tools to ensure your journey is seamless and truly enjoyable.
