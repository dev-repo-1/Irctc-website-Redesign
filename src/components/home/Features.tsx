    ...
    <section className="py-16 lg:py-24 bg-gradient-to-b from-white via-secondary/50 to-background">
      <div className="container max-w-7xl mx-auto px-4 sm:px-6">
        <div
          ...
          <p className="text-muted-foreground text-center mb-12 max-w-xl mx-auto">Experience a truly modern approach to train travel with innovative features designed to make your journey seamless and reliable.
