      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-16 items-center">
        <div className="max-w-xl">
          ...
          <p
            ...
            Book train tickets online effortlessly with our redesigned platform. Experience truly seamless train journeys across India. Get real-time updates, personalized recommendations, and securely book Indian railway tickets, including IRCTC train tickets, for a stress-free travel experience nationwide.
          ...
          <div className="hidden md:flex mt-8 space-x-4 items-center">
            ...
            )}>Trusted by 10M+ travelers nationwide.
